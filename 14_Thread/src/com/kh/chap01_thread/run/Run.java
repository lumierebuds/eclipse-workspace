...
public class Run {
	...
	public static void main(String[] args) {
		...
		/*
		 * 알아볼 수 있는 스레드의 특징들
		 * 1. 스레드는 여러개 동시에 실행이 가능하다. ==> 스레드는 동시성의 특징을 가지고 있음. ==> 더 빠른 반응성을 가져다 준다.
		 * 2. 메인스레드가 종료되더라도 실행중인 스레드가 존재하는경우 프로세스는 종료되지 않는다.  
		 * 3. 매번 결과가 다르게보인다. => 각 스레드의 실행시점을 결정해주는 스케쥴러가 따로 존재하기 때문. 
